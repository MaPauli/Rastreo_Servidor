...
<head>
    ...
    <script src="//maps.google.com/maps/api/js?key=AIzaSyDMhqwR2zg4_jd9h7xRWBlE0TbXm-9ZJis&sensor=false&libraries=adsense"></script>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-4" id="toplogo">
                <img id="halimage" src="images/logo.png">Rastreo de Dispositivos
            </div>
        ...
        <div class="row">
            <div class="col-sm-3 deletediv">
                <input type="button" id="delete" value="Eliminar" tabindex="2" class="btn btn-primary">
            </div>
            <div class="col-sm-3 autorefreshdiv">
                <input type="button" id="autorefresh" value="Desactivar Actualización" tabindex="3" class="btn btn-primary">
            </div>
            ...
            <div class="col-sm-3 viewalldiv">
                <input type="button" id="viewall" value="Ver Recorridos de Usuarios" tabindex="5" class="btn btn-primary">
            </div>
        </div>
    </div>       
</body>
